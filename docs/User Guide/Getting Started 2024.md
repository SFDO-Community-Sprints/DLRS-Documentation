...
![DLRS Beta from the App Launcher](/DLRS-Documentation/docs/assets/images/dlrs_beta_app_launcher.png)

2. On this page, at the top of the list view, click the “New” button.

![DLRS Beta list view and new button](/DLRS-Documentation/docs/assets/images/dlrs_beta_list_view_new_button.png)
...
![DLRS Beta Complete Basic Rule](/DLRS-Documentation/docs/assets/images/dlrs_beta_basic_complete_rule.png)
