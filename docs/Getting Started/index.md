...
|**Text Lookups** | If using ‘Concatenate’ or ‘Concatenate Distinct’ in Aggregate Operation, the delimiter used to separate the values e.g. , (comma) : (semi-colon) etc. To include linebreaks, spaces, and tabs in your delimiter, use BR(), SP(), and TB() respectively.|
|           |         |
